    ...
    <div id="wrap" class="wrap">
        ...
        <div id="content">
            ...
            <div  class="pwSearchWrap">
                ...
                <button class="button white big mt_50" onclick="location.href='search_pw.html' ">다시 찾기</button>
                <button class="button blue big mt_10" onclick="location.href='join.do' ">회원가입</button>
            </div>
            <!--//비밀번호 찾기 전체-->
        </div>
        <!--//컨텐츠 본문-->
