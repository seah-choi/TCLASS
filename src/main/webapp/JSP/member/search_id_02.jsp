        ...
        <div id="content">
            ...
            <div  class="idSerachWrap">
                ...
                <div class="formBox idList atten mt_40">
                    ...
                    <select id="111">
                        <option value=""selected="selected">${dto.memberId }</option>
                    </select>
                </div>
                <p class="txt_01 mt_20">개인정보 보호를 위해<br>아이디는 앞의 4자리만 공개되며, 총 8자리로만 표시합니다.<br>실제 아이디와 글자 수는 다를 수 있습니다.</p>
                <button class="button white big mt_50" onclick="location.href='/TCLASS/member/search_id.do?full=Y&name=${dto.name}&tel=${dto.tel }' ">아이디 전체 확인</button>
