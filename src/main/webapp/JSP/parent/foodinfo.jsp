...
<!-- Mirrored from test-tclassdesign.milkt.co.kr/html/parent/foodinfo.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 May 2023 01:20:33 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <div id="wrap" class="wrap">
        ...
        <div id="content">
            ...
            <div class="foodWrap">
                ...
                <div class="searchBox">
                    <input type="text" id="iname" name="iname" placeholder="학교명으로 식단을 검색해보세요." />
                </div>
                <!--//검색-->
            </div>
            <!--//학교급식 전체-->
