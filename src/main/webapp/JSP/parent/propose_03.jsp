...
<!-- Mirrored from test-tclassdesign.milkt.co.kr/html/parent/propose_03.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 May 2023 01:20:56 GMT -->
<head>
    <meta charset="utf-8" />
            ...
            <div class="oneBoardWrap propose">
                ...
                <div class="boardBox">
                    <ul class="boardWrite">
                        ...
                        <li>
							<div class="proposeChk_grade">
							  <input type="checkbox"  id="cc0" name=""  />
							  <label for="cc0"><span></span>유아</label>
							  <input type="checkbox"  id="cc1" name=""  />
							  <label for="cc1"><span></span>초등</label>
							  <input type="checkbox"  id="cc2" name=""  />
							  <label for="cc2"><span></span>중학</label>
							  <input type="checkbox"  id="cc3" name=""  />
							  <label for="cc3"><span></span>고등</label>
							</div>
                        </li>
                        <li class="titleWrite">
