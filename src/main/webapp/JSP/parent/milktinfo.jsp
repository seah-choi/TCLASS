...
<!-- Mirrored from test-tclassdesign.milkt.co.kr/html/parent/milktinfo.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 May 2023 01:20:33 GMT -->
<head>
    <meta charset="utf-8" />
        ...
        <div id="content">
            ...
            <div class="milktinfoWrap">
                ...
                <div class="milktinfoBox">
                    ...
                    <ul class="boardList">
                        <li>
                            <a href="milktinfo_01.html" target="_self">
                                <p class="title_01">밀크T중학<span>이벤트</span></p>
                        ...
                        <li>
                            <a href="milktinfo_01.html" target="_self">
                                <p class="title_01">밀크T중학<span>이벤트</span></p>
                                <span class="title_02">5월 열공이벤트 당첨자5월 열공이벤트 당첨자</span>
                                <span class="date">2019.08.20</span>
                            </a>
                            <p class="hit">11</p>
                        </li>
