...
<!-- Mirrored from test-tclassdesign.milkt.co.kr/html/parent/univ_consulting_01.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 May 2023 01:20:33 GMT -->
<head>
    <meta charset="utf-8" />
...
<body>
    ...
    <div id="wrap" class="wrap">
        ...
        <div id="content">
          <!--밀크T 정보 전체//-->
            <div class="contentWrap univWrap">
                <ul class="boardView">
                    <li class="vodArea">
                         <a href="#none" >
                             <p class="movBox">
